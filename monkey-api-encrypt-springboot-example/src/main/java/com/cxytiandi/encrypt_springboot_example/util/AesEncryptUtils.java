...
public class AesEncryptUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String content = "{\"name\":\"张*\",\"age\":10,\"sex\":1}";
        System.out.println("加密前：" + content);

        String encrypt = aesEncrypt(content, aesKey);
        System.out.println(encrypt.length() + ":加密后：" + encrypt);

        String decrypt = aesDecrypt("jsjjNwXYT7iPoNwPmk6L49ktViv9t/u5Q1BsvCuuylbKWEzi1xFPEYfv5F9plp0lZuwZdnL28chhUWnFZKWUy/29N/AFdLDMyjHDeF2Anwo=", aesKey);
